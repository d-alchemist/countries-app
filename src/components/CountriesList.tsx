...
export default function CountriesList() {
  ...
  return (
    <>
      <div className="flex justify-between flex-col md:flex-row px-7 md:px-16">
        <div>
      ...
      <div className="px-12 md:px-16 grid gap-20 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 xl:grid-cols-4">
